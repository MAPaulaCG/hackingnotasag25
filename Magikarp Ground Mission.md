...
# Solución
```bash
MpaulaCG-picoctf@webshell:~$ ssh ctf-player@venus.picoctf.net -p 55344
...
Last login: Wed Sep  3 17:41:22 2025 from 127.0.0.1
...
```
Respuesta: picoCTF{xxsh_0ut_0f_\/\/4t3r_540e4e79}
## Notas
Hay que moverse entre directorios y seguir instrucciones
## Referencias