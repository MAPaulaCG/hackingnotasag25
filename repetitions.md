...
# Solución
```bash
MpaulaCG-picoctf@webshell:~$ cat enc_flag 
...
MpaulaCG-picoctf@webshell:~$ cat enc_flag | base64 -d | base64 -d | base64 -d | base64 -d | base64 -d
cGljb0NURntiYXNlNjRfbjNzdDNkX2RpYzBkIW44X2Qwd25sMDRkM2RfNzM0OTQxOTB9Cg==
MpaulaCG-picoctf@webshell:~$ cat enc_flag | base64 -d | base64 -d | base64 -d | base64 -d | base64 -d | base64 -d
picoCTF{base64_n3st3d_dic0d!n8_d0wnl04d3d_73494190}
```
Respuesta:`picoCTF{base64_n3st3d_dic0d!n8_d0wnl04d3d_73494190}`
## Notas
